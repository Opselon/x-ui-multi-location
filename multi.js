...
function resolveTelegramSettings() {
  try {
    ...
    const tokenFromGlobal = typeof TELEGRAM_BOT_TOKEN !== 'undefined' ? `${TELEGRAM_BOT_TOKEN}`.trim() : '';
    const chatFromGlobal = typeof TELEGRAM_CHAT_ID !== 'undefined' ? `${TELEGRAM_CHAT_ID}`.trim() : '';
